...
La IA se utilizó para muchos de los procesos de creación de estas páginas. A continuación, los principales aspectos, entre otros, en los que se utilizó dicha herramienta:
-	Detalles de programación cuando estos implicaban cifras muy específicas. Por ejemplo:
.header-principal {
    display: flex;
    ...
    margin: 30px auto;
    padding: 20px 15px;
    background: linear-gradient(to right, #dbeafe 0%, #ffffff 35%, #6b9ae6 100%);
    border-radius: 18px;
    box-shadow: 0 8px 20px rgba(0,0,0,0.18), 0 0 30px rgba(0,0,0,0.08);
